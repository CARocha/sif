...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PropietarioBosques.secado_horno'
        db.delete_column('bosques_propietariobosques', 'secado_horno')

    def backwards(self, orm):
        # Adding field 'PropietarioBosques.secado_horno'
        db.add_column('bosques_propietariobosques', 'secado_horno',
