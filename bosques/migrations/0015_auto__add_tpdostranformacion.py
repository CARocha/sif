...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tpdostranformacion'
        db.create_table('bosques_tpdostranformacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('bosques', ['Tpdostranformacion'])


    def backwards(self, orm):
        # Deleting model 'Tpdostranformacion'
        db.delete_table('bosques_tpdostranformacion')
    ...
    models = {
        ...
        'bosques.datossegundatranformacion': {
            ...
            'tipo_certificacion': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['bosques.TipoCertificacion']", 'symmetrical': 'False'}),
            'tipo_producto': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['bosques.Tpdostranformacion']", 'null': 'True', 'blank': 'True'}),
        ...
        'bosques.tpdostranformacion': {
            'Meta': {'object_name': 'Tpdostranformacion'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
