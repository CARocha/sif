...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatosSegundaTranformacion.fecha'
        db.add_column('bosques_datossegundatranformacion', 'fecha',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 9, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatosSegundaTranformacion.fecha'
        db.delete_column('bosques_datossegundatranformacion', 'fecha')
