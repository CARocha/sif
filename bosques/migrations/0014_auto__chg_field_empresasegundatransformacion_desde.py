...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmpresaSegundaTransformacion.desde'
        db.alter_column('bosques_empresasegundatransformacion', 'desde', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'EmpresaSegundaTransformacion.desde'
        db.alter_column('bosques_empresasegundatransformacion', 'desde', self.gf('django.db.models.fields.DateField')(default=None))
