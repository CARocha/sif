...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Datos.visita_auditoria'
        db.add_column('bosques_datos', 'visita_auditoria',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datos.auditor'
        db.add_column('bosques_datos', 'auditor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.Auditor'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datos.entidad_certificadora'
        db.add_column('bosques_datos', 'entidad_certificadora',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.EntidadCertificadora'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Datos.visita_auditoria'
        db.delete_column('bosques_datos', 'visita_auditoria')

        # Deleting field 'Datos.auditor'
        db.delete_column('bosques_datos', 'auditor_id')

        # Deleting field 'Datos.entidad_certificadora'
        db.delete_column('bosques_datos', 'entidad_certificadora_id')
