...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Datos.primera_transformacion'
        db.add_column('bosques_datos', 'primera_transformacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.EmpresaPrimeraTransformacion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datos.regente'
        db.add_column('bosques_datos', 'regente',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Datos.primera_transformacion'
        db.delete_column('bosques_datos', 'primera_transformacion_id')

        # Deleting field 'Datos.regente'
        db.delete_column('bosques_datos', 'regente_id')
