...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatosPrimeraTransforma.regente'
        db.alter_column('bosques_datosprimeratransforma', 'regente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.RegenteForestal'], null=True))

    def backwards(self, orm):

        # Changing field 'DatosPrimeraTransforma.regente'
        db.alter_column('bosques_datosprimeratransforma', 'regente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bosques.RegenteForestal']))
