...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatosSegundaTranformacion.volumen_promedio'
        db.alter_column('bosques_datossegundatranformacion', 'volumen_promedio', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DatosSegundaTranformacion.desde_cuando'
        db.alter_column('bosques_datossegundatranformacion', 'desde_cuando', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'DatosSegundaTranformacion.relacion'
        db.alter_column('bosques_datossegundatranformacion', 'relacion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.RelacionComercial'], null=True))

        # Changing field 'DatosPrimeraTransforma.servicio_extraccion'
        db.alter_column('bosques_datosprimeratransforma', 'servicio_extraccion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.ServicioExtraccion'], null=True))

        # Changing field 'DatosPrimeraTransforma.empresa'
        db.alter_column('bosques_datosprimeratransforma', 'empresa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.EmpresaComercializadora'], null=True))

        # Changing field 'DatosPrimeraTransforma.asistencia'
        db.alter_column('bosques_datosprimeratransforma', 'asistencia_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.AsistenciaTecnica'], null=True))

        # Changing field 'DatosPrimeraTransforma.desde'
        db.alter_column('bosques_datosprimeratransforma', 'desde', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DatosPrimeraTransforma.relacion'
        db.alter_column('bosques_datosprimeratransforma', 'relacion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bosques.RelacionComercial'], null=True))
        # Adding field 'Datos.primera_transformacion2'
        db.add_column('bosques_datos', 'primera_transformacion2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='EmpresaPrimeraTransformacion2', null=True, to=orm['bosques.EmpresaPrimeraTransformacion']),
                      keep_default=False)

        # Adding field 'Datos.primera_transformacion3'
        db.add_column('bosques_datos', 'primera_transformacion3',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='EmpresaPrimeraTransformacion3', null=True, to=orm['bosques.EmpresaPrimeraTransformacion']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DatosSegundaTranformacion.volumen_promedio'
        db.alter_column('bosques_datossegundatranformacion', 'volumen_promedio', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'DatosSegundaTranformacion.desde_cuando'
        db.alter_column('bosques_datossegundatranformacion', 'desde_cuando', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'DatosSegundaTranformacion.relacion'
        db.alter_column('bosques_datossegundatranformacion', 'relacion_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bosques.RelacionComercial']))

        # Changing field 'DatosPrimeraTransforma.servicio_extraccion'
        db.alter_column('bosques_datosprimeratransforma', 'servicio_extraccion_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bosques.ServicioExtraccion']))

        # Changing field 'DatosPrimeraTransforma.empresa'
        db.alter_column('bosques_datosprimeratransforma', 'empresa_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bosques.EmpresaComercializadora']))

        # Changing field 'DatosPrimeraTransforma.asistencia'
        db.alter_column('bosques_datosprimeratransforma', 'asistencia_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bosques.AsistenciaTecnica']))

        # Changing field 'DatosPrimeraTransforma.desde'
        db.alter_column('bosques_datosprimeratransforma', 'desde', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'DatosPrimeraTransforma.relacion'
        db.alter_column('bosques_datosprimeratransforma', 'relacion_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bosques.RelacionComercial']))
        # Deleting field 'Datos.primera_transformacion2'
        db.delete_column('bosques_datos', 'primera_transformacion2_id')

        # Deleting field 'Datos.primera_transformacion3'
        db.delete_column('bosques_datos', 'primera_transformacion3_id')
    ...
    models = {
        ...
        'bosques.datos': {
            ...
            'producto_venden': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'producto_vende1'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['bosques.ProVendenBosque']"}),
